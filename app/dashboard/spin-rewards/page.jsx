...
function Page() {
    ...
    const [spinPop, setSpinPop] = useState(false); 
    return (
        <div>
            ...
            { spinPop &&          
                <section className={`bg-[#000000B0] backdrop-blur-[3px] fixed inset-0 z-[99] ${spinPop ? 'pointer-events-auto' : 'pointer-events-none'}`}>
                    <SpinWheel spinPop={spinPop} setSpinPop={setSpinPop}/>
                </section>
            }
        </div>
    )
