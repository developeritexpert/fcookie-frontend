            ...
            <div className="xl:pt-[30px] xl:pb-[50px] overflow-hidden relative ">
                <div className=" container relative before:content-[''] before:absolute before:top-0 before:left-[-100%] before:z-1 before:w-full before:h-full before:bg-[#090702]">
                    <div className="flex justify-between mb-[30px] ">
                        <p className="font-[600] text-[32px] text-white">Top Collections</p>
                    ...
                    <div>
                        <Slider ref={sliderRef} {...settings}>
                            {slides.map((item, i) => (
                                ...
                                <div key={i} className=" pt-[39px] pb-[26px]  w-full flex flex-col items-center bg-[#0D0D0D] border border-[1px] rounded-[14px] [border-image-slice:1] [border-image-source:linear-gradient(180deg,#000,#343434)] ">
                            ...
                            >
                                ...
                                >
                                    <path
                                        ...
                                        className="fill-[#FFFFFF1A] stroke-[#FFFFFF1A] group-hover:fill-[#000] group-hover:stroke-[#000] transition-colors duration-400"
                                    />
                                </svg>
                            </button>
