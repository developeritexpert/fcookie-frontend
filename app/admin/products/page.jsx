...
function Page() {
  ...
  const tableData = [
    { id: 1, productName: "2019 Topos Supreme Quad Autographs", price: "$18,000", sku: "AT234", stock: "120", status: "In Stock", action: "Edit | Remove" },
    { id: 2, productName: "2019 Topos Heritage Real One Autographs", price: "$15,517", sku: "N5678", stock: "0", status: "Out of Stock", action: "Edit | Remove" },
    { id: 3, productName: "2005 SP Signature Autograph Interedible Inscription", price: "$2,760", sku: "S9801", stock: "20", status: "Re-stocking", action: "Edit | Remove" },
    { id: 4, productName: "2019 Ramin One and One Roskie Jersey Autograph", price: "$2,249", sku: "L4321", stock: "78", status: "In Stock", action: "Edit | Remove" },
    { id: 5, productName: "2019 Domuss Optic Roskie Signature Fast Break Gold Pfrom", price: "$2,000", sku: "L8765", stock: "55", status: "In Stock", action: "Edit | Remove" },
    { id: 6, productName: "2019 Ramin One and One Roskie Dual Jersey Autographs", price: "$1,149", sku: "S2222", stock: "0", status: "Out of Stock", action: "Edit | Remove" },
    { id: 7, productName: "2000 Bowman Chrome", price: "$1,098", sku: "C9001", stock: "48", status: "In Stock", action: "Edit | Remove" },
    { id: 8, productName: "2018 Ramin Domuss Prost Prost Black Laser", price: "$2,000", sku: "A9679", stock: "10", status: "Re-stocking", action: "Edit | Remove" },
    { id: 9, productName: "2017 Ramin Contenters' Horizontal Variation Roskie Ticket", price: "$989", sku: "M1357", stock: "0", status: "Out of Stock", action: "Edit | Remove" },
    { id: 10, productName: "2009 SP Game Used Signature Fairtics", price: "$989", sku: "K4410", stock: "12", status: "In Stock", action: "Edit | Remove" }
  ];
  ...
  const getActionButton = (action) => {
    return (
      <span className="tborder border-[#F7F8F81C] bg-[#F7F8F80A] rounded-[7px] py-[6px] px-[15px] text-xs whitespace-nowrap hover:bg-[#F7F8F815] transition-colors cursor-pointer">
        {action}
      </span>
    );
  };
          ...
          <tbody>
            {tableData.map((item) => (
              <tr key={item.id} className='text-[#F7F8F8B2] bg-[#F7F8F81C] hover:bg-[#F7F8F82A] transition-colors'>
                <td className='py-[15px] px-[15px] border border-[#F7F8F81C]'>{item.productName}</td>
                <td className='py-[15px] px-[15px] border border-[#F7F8F81C]'>{item.price}</td>
                <td className='py-[15px] px-[15px] border border-[#F7F8F81C]'>{item.sku}</td>
                <td className='py-[15px] px-[15px] border border-[#F7F8F81C]'>{item.stock}</td>
