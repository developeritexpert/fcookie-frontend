        ...
        <div>
            <div className='px-[20px] md:px-[30px] lg:px-[50px] m-auto pb-[20px] md:pb-[50px] lg:pb-[105px] relative'>
                ...
                <div className="bg-[url('/img/bann1.png')]  bg-cover bg-center  max-w-[1800px] w-full  h-[360px]  md:h-[420px] lg:h-[642px] relative filter  brightness-110 rounded-[10px] md:rounded-[15px] lg:rounded-[25px] ">
                    ...
                    <div className='flex flex-col text-white   absolute left-[15px] top-[15px] right-[15px]   sm:left-[20px] sm:top-[20px]  md:right-auto  md:left-[30px] md:bottom-[-25px] md:top-auto  xl:left-[180px] xl:bottom-[-25px] lg:top-auto lg:max-w-[598px]'>
                        ...
                        <div>
                            <Link href="" className='bg-[#EFB24D] border border-[#EFB24D]  px-[20px] py-[10px] md:px-[30px] md:py-[14px] rounded-[7px] inline-block text-black transition-all duration-300 ease-in-out hover:text-white hover:border hover:border-[#EFB24D]  hover:bg-transparent '>Get Started</Link>
                        </div>
                    </div>
