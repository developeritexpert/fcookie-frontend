...
export default function ProductsSlider(): JSX.Element {
  ...
  return (
    <div className="pt-[30px] lg:pt-[50px] pb-[50px] lg:pb-[110px] px-[20px] md:px-[30px] lg:px-[50px] overflow-hidden relative  ">
      <div className=" move-right absolute   bottom-0 left-[-20%] z-20 w-[300px] h-[110px]   sm:w-[400px] sm:h-[120px]   md:w-[550px] md:h-[130px]   lg:w-[650px] lg:h-[150px]  xl:w-[876px] xl:h-[195px]   bg-[url('/img/fcookie.png')]  bg-no-repeat bg-contain"></div>
        ...
        <div className="container relative">
          ...
          <Slider ref={sliderRef} {...settings}>
            {slides.map((item, i) => (
              <div
                key={i}
                className="h-full p-[14px] pb-[24px] border border-[#E6E6E6] dark:border-[#1E1E1E] w-full bg-white dark:bg-[#0D0D0D] rounded-[14px]  transition-all duration-300 hover:shadow-lg hover:-translate-y-1"
              >
          ...
          <div className="flex justify-between items-center mt-4">
            ...
            <div className="flex items-center gap-4">
              <button
                ...
                className="group border rounded-[21px]  border-[#FFFFFF4D] hover:border-[#EFB24D] hover:bg-[#EFB24D] bg-transparent duration-400 py-[11px] px-[18px] transition "
              >
                <svg
                  width="20"
                  height="12"
