            ...
            <div className='bg-[#090702] px-[60px] pb-[105px] relative'>
                ...
                <div className="bg-[url('/img/bann1.png')] bg-cover bg-center h-[83vh] relative filter  brightness-110 rounded-[25px] ">
                    ...
                    <div className='flex flex-col text-white absolute left-[180px] bottom-[-25px] max-w-[598px]'>
                        <h1 className='text-[50px] font-semibold  mb-[3px]'>Discover. Collect. Trade.</h1>
                        <p className='text-[20px] font-normal leading-[27px] mb-[31px]' >A digital marketplace built for the future of collectibles.
                            <br />
                            Own remarkable digital items with verified authenticity, transparent pricing, and a smooth trading experience.
                        </p>
                        <div>
                            <Link href="" className='bg-[#EFB24D] px-[30px] py-[14px] font-normal rounded-[7px] inline-block text-black'>Get Started</Link>
                        </div>
                    </div>
