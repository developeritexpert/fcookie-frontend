    ...
    <>
      <header className="w-full py-[25px] px-[20px] md:px-[30px] lg:px-[50px]">
        <div className="p-[16px] max-w-[1600px] mx-auto bg-[#FFFFFF12] flex justify-between items-center rounded-[11px] border border-[#EFB24D]/10 dark:border-[#444444]">
          <div className='flex gap-[20px] lg:gap-[75px] items-center'>
            <Link href="/">
              <Image 
            ...
            <div className='hidden lg:flex items-center gap-[75px]'>
          ...
          <div className='hidden lg:flex gap-[10px]'>
            ...
            <div>
              <Link href="/" className='bg-[#EFB24D] text-[#000] px-[30px] py-[10px] font-semibold rounded-[7px] block'>Login</Link>
            </div>
          </div>
          ...
          <div className="lg:hidden flex items-center gap-4">
            ...
            >
              <div className="w-6 h-6 flex flex-col justify-between">
                <span className={`w-full h-0.5 bg-current rounded transition-all duration-300 ${
        ...
        {(isMobileMenuOpen || isAnimating) && (
          <div className="lg:hidden fixed inset-0 z-50">
            ...
            {/* Sidebar */}
            <div 
              className={`mobile-menu fixed right-0 top-0 h-full w-80 bg-white dark:bg-gray-900 shadow-xl transform transition-transform duration-300 ease-out ${
            ...
            >
              ...
              <div className="p-6">
                ...
                <div className="space-y-4 border-t border-gray-200 dark:border-gray-700 pt-6">
                  <button 
                    onClick={() => setTheme(theme === "dark" ? "light" : "dark")}
                    className="w-full bg-[#EFB24D0F] dark:bg-[#FFFFFF0D] cursor-pointer px-4 py-3 text-base flex items-center justify-between font-semibold rounded-[7px]"
                  >
                  ...
                  <Link 
                    href="/" 
                    className="w-full bg-[#EFB24D] text-[#000] px-4 py-3 font-semibold rounded-[7px] block text-center"
                    onClick={toggleMobileMenu}
                  >
                    Login
                  </Link>
