...
export default function ContactForm() {
    ...
    return (
        <div className='pt-[30px] pb-[20px] sm:pt-[40px] sm:pb-[40px] md:pt-[50px] md:pb-[60px] lg:pt-[80px] xl:pb-[100px] px-[20px] md:px-[30px] lg:px-[50px] '>
                ...
                <div className="  grid grid-cols-1 md:grid-cols-2 gap-[20px] sm:gap-[35px] md:gap-0 ">
                    ...
                    <div>
                        ...
                        <div className="text-[16px] font-medium">
                            <div className='flex  items-start gap-[11px] mb-[30px]'>
                                <svg
                                ...
                                <p className='flex gap-[6px] flex-wrap md:flex-nowrap md:gap-0 flex-row md:flex-col'>
                                    ...
                                    <span>Suite 450</span></p>
                            </div>

                            <div className='flex items-center gap-[11px] mb-[25px]'>
                                <svg
                                    width="18"
                                    height="13"
                                    viewBox="0 0 18 13"
                    ...
                    <div className=" w-full mx-auto bg-[#FFFFFF0A]  border border-[#E6E6E6] dark:border-transparent rounded-2xl  ">
                        ...
                        <form className=" px-[15px]  pt-[20px] pb-[30px]  sm:px-[25px]  lg:pt-[30px] lg:pb-[42px] lg:px-[35px] space-y-[22px]">
                            ...
                            {/* Dropdown */}
                            <div>
                                <label className="form-label text-[12px] font-normal text-[#6C6C6C]">How can we help?</label>
                                <div className="relative">
                                    {/* INPUT AREA */}
                                    <div
                                        onClick={() => setOpen(!open)}
                                        className="form-input h-[50px] flex items-center cursor-pointer relative  px-[10px] border border-[#E6E6E6] dark:border-[#FFFFFF1C] rounded-[5px]">
                                    ...
                                    {/* DROPDOWN MENU */}
                                    {open && (
                                        <div className="absolute left-0 top-[54px] w-full bg-white dark:bg-[#0F0F0F] border border-[#E6E6E6] dark:border-[#FFFFFF1C] rounded-md  overflow-hidden z-20">
                                            {options.map((opt) => (
                                                <div
                                                    key={opt}
                                                    onClick={() => {
