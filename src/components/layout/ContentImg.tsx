        ...
        <div className="pt-[30px] pb-[30px]  lg:pt-[50px] lg:pb-[43px]  relative">
            ...
            <div className='px-[20px] md:px-[30px] lg:px-[50px]  overflow-hidden'>
                <div className='container'>
                    <div className='text-[22px] sm:text-[26px] md:text-[35px]  lg:text-[40px] font-semibold leading-[40px] md:leading-[45px] lg:leading-[55px] text-[] dark:text-white text-center max-w-[1195px] m-auto mb-[50px]  sm:mb-[87px]' data-aos="fade-up">
                    ...
                    <div className="relative" data-aos="fade-up" data-aos-delay="100" >
                        <div className='move-right absolute z-0 top-[-30%] sm:top-[-25%] lg:top-[-22%] xl:top-[-19%] right-[-28%] h-[100px] w-[300px] sm:h-[130px] sm:w-[400px] md:h-[150px] md:w-[600px] lg:h-[180px] lg:w-[776px]  xl:h-[200px] xl:w-[876px]'>
