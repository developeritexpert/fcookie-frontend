            ...
            <section className='min-h-[calc(100vh-130px)] py-[50px] px-[20px] md:px-[30px] lg:px-[50px] flex items-center justify-center relative'>
                <div className='mx-auto max-w-[1000px]'>
                    <div className='flex md:flex-row flex-col-reverse gap-[50px] items-center pb-[150px]'>
                        ...
                        <div className='basis-[50%]'>
                            <form>
                                <h1 className='font-semibold text-[30px] md:text-[40px] lg:text-[50px] leading-[1.2]'>Welcome back!</h1>
                                <p className='mb-[20px]'>Sign in to access your collection, track your portfolio, and explore new drops.</p>
                                ...
                                <button type='submit' className='bg-gradient-to-b from-[#75DA5B] to-[#4DCE94] w-full cursor-pointer py-[15px] text-[#000] mb-[10px] font-semibold px-[30px] rounded-[7px]'>Login</button>
                                <p className='text-center text-sm'>{`Don’t have an account?`} <Link href="/register" className='font-semibold'>Create one</Link></p>
                            </form>
                        </div>
                    </div>
