        ...
        <div className='flex md:flex-row flex-col gap-[25px] items-stretch'>
          <div className='border-[#F7F8F81C] border bg-[#F7F8F805] rounded-[7px] p-[20px] lg:p-[30px] flex items-center lg:flex-row md:flex-col flex-row gap-[20px] justify-between basis-[33%]'>
            <div className='flex flex-col lg:items-start md:items-center items-start'>
              <h3 className='font-semibold mb-[10px] lg:mb-[15px] text-[16px] md:text-[18px] text-left md:text-center lg:text-left'>Number of Collectibles Owned</h3>
          ...
          <div className='border-[#F7F8F81C] border bg-[#F7F8F805] rounded-[7px] p-[20px] lg:p-[30px] flex items-center lg:flex-row md:flex-col flex-row gap-[20px] justify-between basis-[33%]'>
            <div className='flex flex-col lg:items-start md:items-center items-start'>
              <h3 className='font-semibold mb-[10px] lg:mb-[15px] text-[16px] md:text-[18px] text-left md:text-center lg:text-left'>Total Rewards Earned (Spin Credits)</h3>
          ...
          <div className='border-[#F7F8F81C] border bg-[#F7F8F805] rounded-[7px] p-[20px] lg:p-[30px] flex items-center lg:flex-row md:flex-col flex-row gap-[20px] justify-between basis-[33%]'>
            <div className='flex flex-col lg:items-start md:items-center items-start'>
              <h3 className='font-semibold mb-[10px] lg:mb-[15px] text-[16px] md:text-[18px] text-left md:text-center lg:text-left'>Last Activity Timestamp</h3>
