    ...
    return (
        <div>
            <div className='px-[20px] md:px-[30px] lg:px-[50px] max-w-[1900px] m-auto pb-[30px] md:pb-[50px] lg:pb-[105px] relative'>
                ...
                <div className="bg-[url('/img/bann1.png')] bg-cover bg-center h-[60vh] md:h-[70vh] lg:h-[83vh] relative filter  brightness-110 rounded-[25px] ">
                    <div className='absolute inset-0 bg-[linear-gradient(0deg,rgba(0,0,0,0.1),rgba(0,0,0,0.1)),linear-gradient(180deg,rgba(255,255,255,0)_43.69%,rgba(255,255,255,0.99)_100%)]   dark:bg-[linear-gradient(180deg,rgba(0,0,0,0)_43.69%,rgba(0,0,0,0.94)_100%),linear-gradient(0deg,rgba(0,0,0,0.2),rgba(0,0,0,0.2))] rounded-[25px] '></div>
                    ...
                    <div className='flex flex-col text-white   absolute left-[15px] top-[15px] right-[15px]    sm:left-[20px] sm:top-[20px] md:right-auto  md:left-[40px] md:top-[40px]   lg:left-[180px] lg:bottom-[-25px] lg:top-auto lg:max-w-[598px]'>
                        ...
                        <p className=' text-[18px] md:text-[20px] leading-[27px] mb-5 md:mb-[31px]' >A digital marketplace built for the future of collectibles.
                            <br />
                            Own remarkable digital items with verified authenticity, transparent pricing, and a smooth trading experience.
                        </p>
                        <div>
                            <Link href="" className='bg-[#EFB24D] px-[20px] py-[10px] md:px-[30px] md:py-[14px] rounded-[7px] inline-block text-black'>Get Started</Link>
                        </div>
                    </div>
