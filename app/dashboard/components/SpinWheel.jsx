...
const SpinWheel = ({spinPop, setSpinPop}) => {
          ...
          <div>
            ...
            <div className="flex justify-center flex-col items-center gap-[30px] relative">
              <div className="relative">
                ...
                >
                  {prizes.map((prize, index) => {
                    ...
                    const isLightColor = prize.color === '#ffe3b0';
              ...
              <button
                onClick={spinWheel} 
                disabled={spinning}
                className={`self-center bg-gradient-to-r from-[#75DA5B] to-[#4DCE94] rounded-[7px] text-black font-semibold px-[20px] py-[10px] text-sm ${spinning
